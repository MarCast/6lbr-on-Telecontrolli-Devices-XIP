...
This version contains the Contiki OS with the addition of the output management, adapted for X.IP4T / X.IP5 devices. In the folder "cc13xx" (located in platform/srf06-cc26xx/srf06) we will find the file board.h. We added the pins IOID_14 to control the output LEDs.
